...
const Hero = () => {
  return (
    <section className='min-h-screen flex flex-col md:flex-row items-center md:px-10 px-6 md:justify-between pt-24 gap-10 ' id='hero'>
        ...
        <div className="flex flex-col items-center md:gap-10 pb-10 gap-5">
